def get_AR_time(data, num_AR_nodes, system):
    ...
    # https://docs.google.com/spreadsheets/d/1jXP-t94jwlTYo7hGxMl8orPWtMEyjqAXAU2iBJpkDMo/edit?usp=sharing
                                            ## This is already in secs
    # AR_time = (4.2e-6 + 2*(num_AR_nodes-1)*system.interchip_link_latency +  2 * (num_AR_nodes-1) * (data/num_AR_nodes) / system.interchip_mem_bw)*1000
    ...
    # print(f'AR time: {data} bytes, {system.interchip_mem_bw} B/s, time:{AR_time} ms')
...
def get_message_pass_time(data, system):
    ...
    # TODO:Change from C2C_BW to message passing BW.
